---
title: INAV Programming Framework (IPF)
description: Add additional functionality through programming logic
---

INAV Programming Framework (IPF) is a mechanism that allows you to to create
custom functionality in INAV.
You can choose for certain actions to be done based on custom conditions you select.
...
* [Servo mixer](../08-inav-configurator/mixer-tab.mdx) to activate/deactivate certain servo mix rulers
...
See the [JavaScript Programming Guide](https://github.com/iNavFlight/inav/blob/master/docs/javascript_programming/JAVASCRIPT_PROGRAMMING_GUIDE.md)
...
| 52            | LED Pin PWM                   | Value `Operand A` from [`0` : `100`] PWM / PINIO generation on LED Pin. See [LED pin PWM](https://github.com/iNavFlight/inav/blob/master/docs/LED%20pin%20PWM.md). Any other value stops PWM generation (stop to allow ws2812 LEDs updates in shared modes). |
...
![screenshot of vtx home distance](/img/features-adv/ipf-vtx-home-distance.png)

### When more than 600 meters away, engage return-to-home by setting the matching RC channel
![screenshot of rth home distance](/img/features-adv/ipf-rth-home-distance.jpg)
...
![screenshot of override an RC channel with a value](/img/features-adv/ipf-set-get-rc-channel.png)

## Related Documentation

- [JavaScript Programming Guide](https://github.com/iNavFlight/inav/blob/master/docs/javascript_programming/JAVASCRIPT_PROGRAMMING_GUIDE.md) - Alternative JavaScript-based syntax for programming logic conditions
- [Operations Reference](https://github.com/iNavFlight/inav/blob/master/docs/javascript_programming/OPERATIONS_REFERENCE.md) - Complete reference for all supported operations in JavaScript
- [Timer and Change Detection Examples](https://github.com/iNavFlight/inav/blob/master/docs/javascript_programming/TIMER_WHENCHANGED_EXAMPLES.md) - Practical examples for time-based patterns
