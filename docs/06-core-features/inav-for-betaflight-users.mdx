...
- Some tips for stabilization PID tuning can be found [here](../05-getting-started/06-mr-gettingstarted.mdx#3-tune-your-copters-pitchrollyawlevel-pids-and-other-values). This will provide better gains to begin tuning from if using a more powerful build.
