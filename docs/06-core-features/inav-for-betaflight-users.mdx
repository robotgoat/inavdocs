...
- Prior to the INAV 7.1 release. The GNSS module required an integrated magnetometer sensor for navigation and still does for the best precision.
  However, GNSS modules without a mag sensor will work from 7.1 on-wards for copter navigation. [See requirements](https://github.com/iNavFlight/inav/wiki/GPS-and-Compass-setup#multi-rotor-without-a-compass)
