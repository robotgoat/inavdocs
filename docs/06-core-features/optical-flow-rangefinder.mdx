...
If calibration fails or optic flow isn't working correctly, see the [Optic Flow and Rangefinder Troubleshooting](./optical-flow.mdx#troubleshooting) section.
