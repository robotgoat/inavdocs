...
The docs project now supports Mise for managing locally scoped Node versions for more consistent reproducibility.
If Mise is installed, run `mise install` to install the tested and working NodeJS environment for the project.
...
- Test your changes to ensure a successful build with `npm run build`.
