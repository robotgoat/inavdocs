...
* Unable to enable NAV related modes, see [Navigation-modes](/docs/features/Navigation-modes.md) for possible reasons for why.
...
* INAV has GPS modes that differ from Cleanflight, or names them differently. Read [this wiki page](/docs/features/Navigation-modes.md) for how to use them, and combine them, to get the wanted position hold.
