...
This wiki topic describes the software currently available and some of the telemetry options. Please also see the [wiki page on more general navigation mode options](/docs/features/Navigation-modes.md#wp---autonomous-waypoint-mission).
